...
namespace IntegrationStudioPlaywrightAutomation.ComponentTests
{
    ...
    public class NotificationHub_UI_Tests : BaseTest
    {
        ...
        [Test]
        public async Task OpenNotificationBellIcon_ShouldOpen_NotificationPanel()
        {
        ...
        [Test]
        public async Task OpenNotificationPanel_ShouldContain_NumberOfNotifications()
        {
        ...
        [Test]    
        public async Task OpenNotificationPanel_ShouldContain_ClearAll_Button()
        {
            ...
            {
                Path = "Screenshot_Of_NotificationClearAllButton.png"
            });
        ...
        [Test]
        public async Task OpenNotificationPanel_ShouldContain_CloseButton()
        {
